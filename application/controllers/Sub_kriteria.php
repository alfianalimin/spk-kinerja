...
<?php
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() != false) {
            ...
            if ($result) {
                $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data Sub Kriteria berhasil disimpan!</div>');
    ...
    public function update($id_sub_kriteria)
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data Sub Kriteria berhasil diupdate!</div>');
        // redirect('sub_kriteria');
        redirect('kriteria');
    }
    ...
    public function destroy($id_sub_kriteria)
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data Sub Kriteria berhasil dihapus!</div>');
        // redirect('sub_kriteria');
        redirect('kriteria');
    }
}
