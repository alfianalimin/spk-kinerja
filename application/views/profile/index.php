		...
		<div class="card-body">
			<div class="row">
				...
				<select name="posisi" class="form-control" required>
					...
					<option value="Sekretariat" <?php if ($profile->posisi == "Sekretariat") {
												echo 'selected';
											} ?>>Sekretariat</option>
					<option value="PBB-P2" <?php if ($profile->posisi == "PBB-P2") {
												echo 'selected';
											} ?>>PBB-P2</option>
					<option value="Pajak Daerah" <?php if ($profile->posisi == "Pajak Daerah") {
												echo 'selected';
											} ?>>Pajak Daerah</option>
					<option value="Evaluasi" <?php if ($profile->posisi == "Evaluasi") {
												echo 'selected';
											} ?>>Evaluasi</option>
					<option value="Litbang" <?php if ($profile->posisi == "Litbang") {
												echo 'selected';
											} ?>>Litbang</option>
				</select>
