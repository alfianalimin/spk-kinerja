		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<select name="posisi" class="form-control" required id="edt_bidang">
						<option value="">--Pilih Bidang--</option>
						<option value="Kepala Badan">Kepala Badan</option>
						<option value="Sekretariat">Sekretariat</option>
						<option value="PBB-P2">PBB-P2</option>
						<option value="Pajak Daerah">Pajak Daerah</option>
						<option value="Evaluasi">Evaluasi</option>
						<option value="Litbang">Litbang</option>
					</select>
					<script>
						document.getElementById('edt_bidang').value="<?php echo $User->posisi ?>";
					</script>
					<!-- <input autocomplete="off" type="text" name="posisi" value="<?php //echo $User->posisi ?>" required class="form-control"/> -->
				</div>
